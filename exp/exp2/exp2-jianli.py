...
#读取excel中的信息
wb = load_workbook(r'exp/exp2/share/简历信息.xlsx')
ws = wb.active
#根据简历信息中的每行生成一个简历，即为每个公司生成一份专属简历
file_num = 1
for row in range(2, ws.max_row + 1):
    doc = Document(r'exp/exp2/share/简历模板.docx')
    ...
    run.add_picture(r'exp/exp2/output/cs-binary.png', width=Inches(1), height=Inches(0.5))
    #基于更新后的简历模板生成以对应公司命名的简历
    com_name = str(ws.cell(row=row, column=1).value)
    doc.save(f'exp/exp2/output/简历{file_num}.docx')
    file_num += 1
